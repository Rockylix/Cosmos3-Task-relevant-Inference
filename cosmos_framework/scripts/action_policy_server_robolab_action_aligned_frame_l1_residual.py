...
"""RoboLab server for action-aligned per-frame/L1-residual completion."""
...
def main() -> None:
    server.ActionAttentionMass90Controller = ActionAttentionAlignedFrameL1ResidualController
    if "--intervention-output-dir" not in sys.argv:
        sys.argv.extend(
            [
                ...
                "action_attention_aligned_frame_mass90_l1_residual_shift5_BananaInBowlTask_sim_v1/server",
            ]
        )
    server.main()
